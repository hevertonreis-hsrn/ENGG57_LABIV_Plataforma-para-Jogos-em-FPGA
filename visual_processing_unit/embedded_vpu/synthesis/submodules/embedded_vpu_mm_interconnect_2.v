// embedded_vpu_mm_interconnect_2.v
...
`timescale 1 ps / 1 ps
module embedded_vpu_mm_interconnect_2 (
	...
	embedded_vpu_mm_interconnect_2_router router (
	...
	embedded_vpu_mm_interconnect_2_router_001 router_001 (
	...
	embedded_vpu_mm_interconnect_2_cmd_demux cmd_demux (
		.clk                (clk_clk_clk),                                         //       clk.clk
		.reset              (background_loader_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	embedded_vpu_mm_interconnect_2_cmd_mux cmd_mux (
		.clk                 (clk_clk_clk),                                         //       clk.clk
		.reset               (background_loader_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	embedded_vpu_mm_interconnect_2_cmd_demux rsp_demux (
		.clk                (clk_clk_clk),                                         //       clk.clk
		.reset              (background_loader_reset_reset_bridge_in_reset_reset), // clk_reset.reset
	...
	embedded_vpu_mm_interconnect_2_rsp_mux rsp_mux (
		.clk                 (clk_clk_clk),                                         //       clk.clk
		.reset               (background_loader_reset_reset_bridge_in_reset_reset), // clk_reset.reset
