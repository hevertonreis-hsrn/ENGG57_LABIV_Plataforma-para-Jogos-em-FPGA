...
alias com {
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/embedded_vpu_tb/simulation/submodules/embedded_vpu_key.v"                                                                               -work key                                            
  ...
  eval  vlog $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS     "$QSYS_SIMDIR/embedded_vpu_tb/simulation/submodules/sprite_rom_4port.v"                                                                               -work composer                                       
  ...
  eval  vlog -sv $USER_DEFINED_VERILOG_COMPILE_OPTIONS $USER_DEFINED_COMPILE_OPTIONS "$QSYS_SIMDIR/embedded_vpu_tb/simulation/submodules/altera_conduit_bfm_0003.sv"                                          -L altera_common_sv_packages -work embedded_vpu_inst_key_external_connection_bfm  
